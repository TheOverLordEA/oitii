...
const HomePageHeader = async () => {
  ...
  return (
    <header className="px-4 lg:px-6 py-12 h-16 flex items-center justify-center bg-white sticky top-0 z-50 border-b border-gray-200">
      <div className="flex justify-between items-center w-4/5 max-w-7xl">
        {/* Left side - Logo */}
        <div className="w-40">
