...
const TemporaryHeader = async () => {
  ...
  return (
    <header className="px-4 lg:px-6 py-12 h-16 flex items-center justify-evenly bg-[#111827] sticky top-0 z-50 border-b border-gray-200">
